...
export default function Upload(){
 ...
 return <main className="white-page">
  <header className="p-5 flex justify-between items-center border-b"><div className="flex items-center gap-3"><Link href="/" className="font-black text-2xl">← JAKWO</Link><a className="jakwo-pump-exact" href="https://pump.fun/coin/EgarvX6JFtcqmjXw5aAvk9yTLa3CnwNmdbwAmwPNpump" target="_blank" rel="noopener noreferrer" aria-label="Open JAKWO on Pump.fun"><img src="/pump-pill.jpg" alt="Pump.fun JAKWO" /></a></div><b>Upload War Ad</b></header>
