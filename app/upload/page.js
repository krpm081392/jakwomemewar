...
export default function Upload(){
  ...
  return <main className="upload-page">
    <div className="upload-head"><Link href="/" className="brand"><span>JAKWO</span><b>WAR ARENA</b></Link><div><a className="jakwo-pump-exact" href="https://pump.fun/coin/EgarvX6JFtcqmjXw5aAvk9yTLa3CnwNmdbwAmwPNpump" target="_blank" rel="noopener noreferrer" aria-label="Open JAKWO on Pump.fun"><img src="/pump-pill.jpg" alt="Pump.fun JAKWO" /></a><button className="btn phantom" onClick={connect}>{wallet?'CONNECTED':'CONNECT PHANTOM'}</button><button className="btn red" onClick={()=>setPanel(!panel)}>ADD AD</button></div></div>
