...
export default function Home(){
 ...
 return <main className="paper min-h-screen">
  ...
  <header className="relative z-10 max-w-7xl mx-auto px-4 py-8 flex flex-wrap gap-4 items-center justify-between">
   ...
   <nav className="flex gap-3 flex-wrap"><Link className="btn dark" href="/upload">PLACE WAR AD</Link><Link className="btn" href="/admin">ADMIN</Link><a className="pump-link" data-jakwo-pump-direct="1" href="https://pump.fun/coin/EgarvX6JFtcqmjXw5aAvk9yTLa3CnwNmdbwAmwPNpump" target="_blank" rel="noopener noreferrer" aria-label="Buy JAKWO on Pump.fun"><img src="/pill.png" alt="Pump.fun JAKWO"/></a><a className="btn" href={SITE.twitter} target="_blank">X</a><a className="btn" href={SITE.telegram} target="_blank">Telegram</a></nav>
  </header>
